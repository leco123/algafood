...
* [CONCEITOS](#conceitos)
  ...
  * [ETags](#etags)
    * [Status da requisição](#status-da-requisio)
  ...
  * [Como fazer documentação usando a especificação OpenApi](#como-fazer-documentao-usando-a-especificao-openapi)
* [ATUALIZAÇÕES](#atualizaes)
    * [18.15. Referenciando modelo de representação de problema com códigos de status de erro](#1815-referenciando-modelo-de-representao-de-problema-com-cdigos-de-status-de-erro)
