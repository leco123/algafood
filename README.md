...
* [GERAR PAR DE CHAVES COM KEYTOOL](#gerar-par-de-chaves-com-keytool)
    ...
    * [Extraindo a chave pública do arquivo jks no formato PEM](#extraindo-a-chave-pública-do-arquivo-jks-no-formato-pem)
      * [Gerando o certificado](#gerando-o-certificado)
      * [Gerando a chave pública](#gerando-a-chave-pública)
* [COMO INSTALAR OPENSSL NO WINDOWS](#como-instalar-openssl-no-windows)
